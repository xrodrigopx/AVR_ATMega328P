...
;-------------------------------------------------------------------------------------
; Observar la rutina sacanum, utiliza r21 para los LEDs del numero que quiero mostar, r17 para indicar dónde lo quiero mostrar
...
main:	;	  ABCDEFGH
	ldi r16,0b10011111		;aquí saco el '0' por el Display
	ldi r17,0b10000000
	call sacanum
	rjmp main;
...
sacanum: 
	call	dato_serie
	mov		r16, r17	;la instrucción mov copia lo que hay en r17 a r16
	call	dato_serie
